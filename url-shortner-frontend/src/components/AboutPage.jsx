  ...
  return (
    <div className="lg:px-14 sm:px-8 px-5 min-h-[calc(100vh-64px)] pt-2">
      <div className="bg-white w-full sm:py-10 py-8  ">
        ...
        ShortNest offers a seamless and efficient way to shorten long URLs for easy sharing and organization.
        With a focus on simplicity and control, ShortNest lets you create, manage, and monitor your links effortlessly.
        Whether you're sharing content across platforms or organizing links for personal use,
        ShortNest keeps everything secure and in one place. Experience smart link management — all nested 
        in one powerful tool. ShortNest offers a seamless and efficient way to shorten long URLs for 
        easy sharing and organization. With a focus on simplicity and control, ShortNest lets you
        create, manage, and monitor your links effortlessly.
        </p>
